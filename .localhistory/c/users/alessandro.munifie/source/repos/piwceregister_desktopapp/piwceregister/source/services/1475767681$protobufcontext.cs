...
namespace PIWCeRegister.Source.Services
{
    ...
    class ProtobufContext : DynamicObject
    {
        ...
        public List<T> Context<T> () where T:class
        {
            return instance.GetPropertyValue<T>(typeof(T).Name + "s");
        }
        ...
        public void ExecutorInterface<T>(object func) where T : class
        {
            Init<T>(func as List<T>);
